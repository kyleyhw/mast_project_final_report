\documentclass[floats,floatfix,showpacs,amssymb,prd,superscriptaddress,nofootinbib, 11pt]{revtex4-2} % documentation at https://journals.aps.org/revtex/revtex-faq#u2
...
%, which serves as a convenient consistency check. 
